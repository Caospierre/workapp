...
import app.recognizerface.env.FileUtils;
import app.recognizerface.wrapper.FaceNet;
import app.recognizerface.wrapper.LibSVM;
import app.recognizerface.wrapper.MTCNN;
...
public class Classifier {
    /**
     *
     * Un resultado inmutable devuelto por un Classifier describiendo lo que fue reconocido.
     */
    public class Recognition {
        /**
         Un identificador único para lo que se ha reconocido. Específico a la clase, no a la instancia de
         * el objeto.
         */
        ...
        /**
         * Una puntuación ordenable de cuán bueno es el reconocimiento en relación con los demás. Más alto debería ser mejor.         */
        private final Float confidence;

        /*
         *Ubicación opcional dentro de la imagen de origen para la ubicación del objeto reconocido. * * /
         */
